...
Some key content from the architecture documentaion:
...
The *database documentation* was created with the Documentation Generator: xref:sqldb:docs.usp_AntoraExport.adoc[] +
