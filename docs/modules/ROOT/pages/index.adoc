...
TIP: Read the xref:arc:architecture.adoc[] documentation to learn why DataHandwerk exists, how it works and is built. Some key includes from the architecture documentaion:
...
The *database documentation* was created with the Documentation Generator: xref:sqldb:docs.usp_AntoraExport.adoc[]. The documentation also shows

* the combination of real and virtual PK (only for tables and views)
