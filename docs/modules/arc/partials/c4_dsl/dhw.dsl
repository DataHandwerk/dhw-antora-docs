workspace {
    model {
        enterprise "Customer" {
            ...
            project_b_dev = softwareSystem "DWH B Development" {
                project_b_repo_db = container "Repository db (Project B)" "" "Database" "Database" {
                    ...
                    repo_property = component "Properties and Inheritance" "Inheritance or determination of extended properties for RepoObjects or RepoObject columns, based on references"
                ...
                documentation = container "documentation" "database documentation" "documentation" "documentation" {
        ...
        documentation -> repo_generator_docs "content generated by"
