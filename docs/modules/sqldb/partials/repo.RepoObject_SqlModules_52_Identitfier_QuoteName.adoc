...
.Referenced Columns
--
* xref:repo.RepoObject_SqlModules_51_Identitfier.adoc#column-source_column[repo.RepoObject_SqlModules_51_Identitfier.source_column]
--
...
.Referenced Columns
--
* xref:repo.RepoObject_SqlModules_51_Identitfier.adoc#column-source_table[repo.RepoObject_SqlModules_51_Identitfier.source_table]
--
