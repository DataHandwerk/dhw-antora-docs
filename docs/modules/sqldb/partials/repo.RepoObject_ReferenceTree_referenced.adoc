= [repo].[RepoObject_ReferenceTree_referenced]
...
--bad performance
CREATE View [repo].[RepoObject_ReferenceTree_referenced]
As
Select
    tree.*
From
    repo.RepoObject_gross                                                                     As ro
    Cross Apply repo.ftv_RepoObject_ReferenceTree_referenced ( ro.RepoObject_guid, 100, 100 ) As tree
Where
