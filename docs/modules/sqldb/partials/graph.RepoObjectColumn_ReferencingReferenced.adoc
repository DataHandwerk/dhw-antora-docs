...
.Referencing Columns
--
* xref:repo.RepoObjectColumn_ReferencingList.adoc#column-Referenced_guid[repo.RepoObjectColumn_ReferencingList.Referenced_guid]
--
...
.Referencing Columns
--
* xref:repo.RepoObjectColumn_ReferencedList.adoc#column-Referencing_guid[repo.RepoObjectColumn_ReferencedList.Referencing_guid]
--
