...
.Referencing Columns
--
* xref:repo.RepoObjectColumnProperty_InheritanceType_resulting_InheritanceDefinition.adoc#column-Inheritance_StringAggSeparatorSql[repo.RepoObjectColumnProperty_InheritanceType_resulting_InheritanceDefinition.Inheritance_StringAggSeparatorSql]
--
...
.Referencing Columns
--
* xref:repo.RepoObjectColumnProperty_InheritanceType_resulting_InheritanceDefinition.adoc#column-InheritanceDefinition[repo.RepoObjectColumnProperty_InheritanceType_resulting_InheritanceDefinition.InheritanceDefinition]
--
...
.Referencing Columns
--
* xref:repo.RepoObjectColumnProperty_InheritanceType_resulting_InheritanceDefinition.adoc#column-InheritanceType[repo.RepoObjectColumnProperty_InheritanceType_resulting_InheritanceDefinition.InheritanceType]
--
...
.Referencing Columns
--
* xref:repo.RepoObjectColumnProperty_InheritanceType_resulting_InheritanceDefinition.adoc#column-property_name[repo.RepoObjectColumnProperty_InheritanceType_resulting_InheritanceDefinition.property_name]
--
...
.Referencing Columns
--
* xref:repo.RepoObjectColumnProperty_InheritanceType_resulting_InheritanceDefinition.adoc#column-property_value[repo.RepoObjectColumnProperty_InheritanceType_resulting_InheritanceDefinition.property_value]
--
...
.Referencing Columns
--
* xref:repo.RepoObjectColumnProperty_InheritanceType_resulting_InheritanceDefinition.adoc#column-RepoObjectColumn_guid[repo.RepoObjectColumnProperty_InheritanceType_resulting_InheritanceDefinition.RepoObjectColumn_guid]
--
...
.Referencing Columns
--
* xref:repo.RepoObjectColumnProperty_InheritanceType_resulting_InheritanceDefinition.adoc#column-RepoObjectColumn_name[repo.RepoObjectColumnProperty_InheritanceType_resulting_InheritanceDefinition.RepoObjectColumn_name]
--
...
[source,sql]
----
CREATE View repo.RepoObjectColumnProperty_InheritanceType_InheritanceDefinition
As
Select
    --
