...
* connect repo datatabase to dwh database using synonyms executing the storred procedure xref:sqldb:config.usp_connect_database.adoc[]
+
...
The post deployment script will be executed, if you use publish or build, but it is not executed, when using schemacompare. You can also just copy the code from here and execute it. +
